<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	if(categorie == null) {
		response.sendRedirect("./home?page=XboxSeries.jsp");	
		return;
	}
%>
<!DOCTYPE html>
...
<%@ include file="../fragments/header.jsp" %>
	...
	<%
	ArrayList<ProdottoBean> xboxSeries = categorie.get(1);%>
	...
	<h2>XBOX SERIES</h2>
		...
		<div class="item">
			...
			<li><a href="carrello?action=addC&id=<%=bean.getIdProdotto()%>&page=XboxSeries.jsp"><button>Aggiungi al carrello</button></a></li>
		 </ul>
		</div>
		<%
				}
